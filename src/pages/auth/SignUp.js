    ...
    <div className="min-h-screen bg-white flex flex-col lg:flex-row">
      {/* Left Side - Form */}
        <div className="flex-1 flex flex-col lg:justify-center px-4 sm:px-6 lg:px-8 xl:px-12 py-8 lg:py-12 lg:pl-[135px]">
          {/* Logo */}
          <div className="flex items-center gap-3 mb-8 lg:mb-12 lg:absolute lg:top-[40px] lg:left-[183px]">
          <img 
            src={logoImage}
            alt="Maglo Logo"
            className="w-[30px] h-[30px]"
          />
          <span className="font-['Gordita'] font-bold text-lg text-[#1a1a1a]">Maglo.</span>
        </div>

        {/* Form Container */}
        <div className="w-full max-w-md mx-auto lg:mx-0 lg:max-w-lg lg:ml-[135px]">
          <div className="mb-8">
